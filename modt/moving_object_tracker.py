...
# coco_path=os.path.join(basedir,'data/labels', 'coco.names')    
# weights_path=os.path.join(basedir,'weights', 'yolov3.tf')    
# model_path=os.path.join(basedir,'model_data', 'mars-small128.pb')    
# video_path=os.path.join(basedir,'data/video', 'a.mp4')    



class_names = [c.strip() for c in open('./data/labels/coco.names').readlines()]
# class_names = [c.strip() for c in open(coco_path).readlines()]
